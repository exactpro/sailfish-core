CREATE OR REPLACE FUNCTION tagged_sets_comparison(IN first_ids bigint[], IN first_count bigint, IN second_ids bigint[], IN second_count bigint)
    ...
    ftcid bigint, fmatrix character varying(255), fpassed boolean, ffailreason character varying(255), fcomment text, fuserStatus text, ftcrid bigint, fmrid bigint,
        fstarttime timestamp, ffinishtime timestamp, ftags text,
    stcid bigint, smatrix character varying(255), spassed boolean, sfailreason character varying(255), scomment text, suserStatus text, stcrid bigint, smrid bigint,
