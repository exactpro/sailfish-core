...
(
  tcr_id bigint NOT NULL,
  tag_id bigint NOT NULL,
  custom boolean,
  CONSTRAINT sttcrtags_pkey PRIMARY KEY (tcr_id , tag_id ),
  CONSTRAINT sttags_fkey FOREIGN KEY (tag_id)
      REFERENCES sttags (id) MATCH SIMPLE
      ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT sttestcaseruns_fkey FOREIGN KEY (tcr_id)
      REFERENCES sttestcaseruns (id) MATCH SIMPLE
      ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE INDEX sttcrtags_tcr_id_idx ON sttcrtags USING btree (tcr_id);
CREATE INDEX sttcrtags_tag_id_idx ON sttcrtags USING btree (tag_id);
CREATE INDEX sttestcaseruns_matrix_run_id_idx ON sttestcaseruns USING btree (matrix_run_id);
CREATE INDEX sttestcaseruns_tc_id_idx ON sttestcaseruns USING btree (tc_id);
