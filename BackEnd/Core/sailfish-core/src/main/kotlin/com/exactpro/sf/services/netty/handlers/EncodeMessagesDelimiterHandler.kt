...
/**
 * This class should be use to produce a mark that means that the all input messages processed.
 ...
 */
class EncodeMessagesDelimiterHandler : MessageToMessageEncoder<IMessage>() {
