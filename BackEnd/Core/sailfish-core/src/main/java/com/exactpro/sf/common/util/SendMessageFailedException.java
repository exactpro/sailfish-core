...
public class SendMessageFailedException extends RuntimeException {
     ...
     * 
     */
    private static final long serialVersionUID = -4083260197339295182L;
     ...
     */
    public SendMessageFailedException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
