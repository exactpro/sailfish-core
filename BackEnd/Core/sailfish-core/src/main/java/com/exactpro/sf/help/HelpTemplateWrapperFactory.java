...
public class HelpTemplateWrapperFactory {
    ...
    public HelpTemplateWrapper createWrapper(String templateName) throws IOException {
        return new HelpTemplateWrapper(configuration.getTemplate(templateName));
    }
}
