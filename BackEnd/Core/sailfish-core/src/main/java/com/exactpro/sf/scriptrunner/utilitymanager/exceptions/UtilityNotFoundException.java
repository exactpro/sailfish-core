...
public class UtilityNotFoundException extends EPSCommonException {
    private static final long serialVersionUID = -8426922364609931564L;
    ...
    public UtilityNotFoundException(Throwable cause) {
        super(cause);
    }
