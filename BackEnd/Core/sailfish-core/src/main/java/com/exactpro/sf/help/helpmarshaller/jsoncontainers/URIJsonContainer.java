...
public class URIJsonContainer  extends HelpJsonContainer{
    ...
    public URIJsonContainer(String name, String filePath, String icon, HelpEntityType type, SailfishURI uri) {
        super(name, filePath, icon, type);
        this.uri = uri;
    }

    public URIJsonContainer(){
