...
public interface IConverter<T> {
    ...
    T convert(BigDecimal value);

    T convert(Character value);

    T convert(String value);

    T convert(LocalDate value);

    T convert(LocalTime value);

    T convert(LocalDateTime value);
