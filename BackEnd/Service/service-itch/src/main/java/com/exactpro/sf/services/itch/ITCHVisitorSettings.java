...
public class ITCHVisitorSettings {
    ...
    public static ITCHVisitorSettings from(ITCHCodecSettings codecSettings) {
        ITCHVisitorSettings settings = new ITCHVisitorSettings();
