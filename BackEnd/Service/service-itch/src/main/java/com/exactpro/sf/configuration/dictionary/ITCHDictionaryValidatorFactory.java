...
import com.exactpro.sf.configuration.dictionary.impl.ITCHDictionaryValidator;
import com.exactpro.sf.configuration.dictionary.interfaces.IDictionaryValidator;
import com.exactpro.sf.configuration.dictionary.interfaces.IDictionaryValidatorFactory;

public class ITCHDictionaryValidatorFactory implements IDictionaryValidatorFactory {

    public IDictionaryValidator createDictionaryValidator() {
        return new ITCHDictionaryValidator(DefaultDictionaryValidator.INSTANCE);
    }
}