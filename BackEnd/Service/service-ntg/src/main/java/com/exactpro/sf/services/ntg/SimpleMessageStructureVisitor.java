...
public abstract class SimpleMessageStructureVisitor implements IMessageStructureVisitor {
	...
	public abstract void visit(String fieldName, Object value, IFieldStructure fldStruct, boolean isDefault);

	public abstract void visitCollection(String fieldName, List<?> value, IFieldStructure fldStruct, boolean isDefault);

	public abstract void visitMessage(String fieldName, IMessage message, IFieldStructure complexField,
			IFieldStructure fldStruct, boolean isDefault);

	@Override
	public abstract void visitMessageCollection(String fieldName, List<IMessage> message,
			IFieldStructure complexField, boolean isDefault);

	@Override
	public void visit(String fieldName, Boolean value, IFieldStructure fldStruct, boolean isDefault) {
		visit(fieldName, (Object) value, fldStruct, isDefault);
	}

	@Override
	public void visitBooleanCollection(String fieldName, List<Boolean> value, IFieldStructure fldStruct,
			boolean isDefault) {
		visitCollection(fieldName, value, fldStruct, isDefault);
	}
	...
	@Override
	public void visitCharCollection(String fieldName, List<Character> value, IFieldStructure fldStruct,
			boolean isDefault) {
		visitCollection(fieldName, value, fldStruct, isDefault);
	}
	...
	@Override
	public void visitBigDecimalCollection(String fieldName, List<BigDecimal> value, IFieldStructure fldStruct,
			boolean isDefault) {
		visitCollection(fieldName, value, fldStruct, isDefault);
	}
	...
	@Override
	public void visit(String fieldName, IMessage message, IFieldStructure complexField,
			boolean isDefault) {
		visitMessage(fieldName, message, complexField, complexField, isDefault);
	}
