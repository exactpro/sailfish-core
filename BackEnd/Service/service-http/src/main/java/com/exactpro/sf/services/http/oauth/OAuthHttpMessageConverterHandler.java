...
public class OAuthHttpMessageConverterHandler extends ChannelDuplexHandler {

    private final OAuthHttpMessageConverter messageConverter;

    public OAuthHttpMessageConverterHandler(OAuthHttpMessageConverter messageConverter) {
    ...
    public void channelRead(@NotNull ChannelHandlerContext context, @NotNull Object msg) throws Exception {
        if (msg instanceof FullHttpResponse) {
            ...
            IMessage message = messageConverter.fullHttpResponseToMessage(response).getMessage();
