...
import com.exactpro.sf.services.json.handlers.JSONMatcherHandlerEncode;
...
public class JSONClient extends HTTPClient {
    ...
    protected MessageToMessageEncoder<IMessage> getEncodeMatcherHandler(Queue<ResponseInformation> queue, AtomicReference<String> cookie) {
        return new JSONMatcherHandlerEncode(dictionary, settings, msgFactory, getName(), queue, channelBusy, cookie);
    }
