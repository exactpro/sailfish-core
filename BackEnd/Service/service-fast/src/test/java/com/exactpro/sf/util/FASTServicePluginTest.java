...
public class FASTServicePluginTest extends AbstractTest {
    ...
    protected FASTCodec getCodec(SailfishURI dictURI, String dictName) {
        FASTClientSettings settings = new FASTClientSettings();
        settings.setDictionaryName(dictURI);
        IMessageFactory msgFactory = DefaultMessageFactory.getFactory();
        String pathName = SAILFISH_DICTIONARY_PATH + dictName + ".xml";
