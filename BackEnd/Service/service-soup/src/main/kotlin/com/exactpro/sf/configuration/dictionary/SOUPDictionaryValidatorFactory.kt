...
class SOUPDictionaryValidatorFactory : IDictionaryValidatorFactory {
    override fun createDictionaryValidator(): IDictionaryValidator = SOUPDictionaryValidator(DefaultDictionaryValidator.INSTANCE)
}