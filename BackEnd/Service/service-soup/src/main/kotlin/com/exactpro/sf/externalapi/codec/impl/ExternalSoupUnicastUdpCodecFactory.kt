...
import com.exactpro.sf.services.itch.soup.SOUPUnicastUdpCodec

class ExternalSoupUnicastUdpCodecFactory : AbstractExternalMinaCodecFactory() {
    override val codecClass: Class<out AbstractCodec> = SOUPUnicastUdpCodec::class.java
