...
public class QFJMessage2IMessageTest extends ConverterTest {
    ...
    public void testDirtyFIXHumanFormat() throws Exception {
        ...
        Assert.assertEquals("header={BeginString(8)=FIXT.1.1; BodyLength(9)=239; MsgType(35)=ORDER_SINGLE(D); MsgSeqNum(34)=2; SenderCompID(49)=NGALL1FX01; TargetCompID(56)=FGW; "
                ...
                + "TransactTime(60)=20180205-10:38:08.000008; trailer={CheckSum(10)=055}", MessageUtil.convertToIHumanMessage(messageFactory, dictionary.getMessages().get(iMessage.getName()), iMessage).toString());
