...
public class EnvironmentUpdateEvent implements AbstractUpdateEvent {
    private EnvironmentEvent event;

    public EnvironmentUpdateEvent(EnvironmentEvent event) {
        this.event = event;
    }

    public EnvironmentEvent getEvent() {
        return event;
    }

    public void setEvent(EnvironmentEvent event) {
        this.event = event;
    }
}
