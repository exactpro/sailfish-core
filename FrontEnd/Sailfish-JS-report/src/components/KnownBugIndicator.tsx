...
export class KnownBugIndicator extends Component<KnownBugIndicatorProps, {}> {
    render({ data }: KnownBugIndicatorProps) {
        return (
            <div class={"known-bugs__indicator " + (hasReproducedBugs(data) ? "reproduced" : "not-reproduced")} />
        )
    }
}
